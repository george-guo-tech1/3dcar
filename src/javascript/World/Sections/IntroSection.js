...
export default class IntroSection
{
    ...
    setTitles()
    {
        ...
        // this.objects.add({
        //     base: this.resources.items.peu.scene,
        //     collision: this.resources.items.peu.scene,
        //     offset: new THREE.Vector3(0, 0, 0),
        //     rotation: new THREE.Euler(0, 0, 0),
        //     shadow: { sizeX: 2.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.3 },
        //     mass: 1.5,
        ...
        // })
        // this.objects.add({
        //     base: this.resources.items.test.scene,
        //     collision: this.resources.items.introCreativeCollision.scene,
        //     offset: new THREE.Vector3(0, 0, 0),
        //     rotation: new THREE.Euler(0, 0, 0),
        //     shadow: { sizeX: 2.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.3 },
        ...
        // })
        this.objects.add({
            base: this.resources.items.nissan.scene,
            collision: this.resources.items.nissan.scene,
            offset: new THREE.Vector3(5.85, 0, 0),
            rotation: new THREE.Euler(0, 0, 0),
            shadow: { sizeX: 2.5, sizeY: 1.5, offsetZ: - 0.6, alpha: 0.3 },
            mass: 1.5,
